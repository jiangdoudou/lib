#!/bin/bash
#
# Copyright (c) 2015 Mehmet Nuri Öztürk info@mehmetnuriozturk.com.tr
#
# www.mehmetnuriozturk.com.tr
#
...
now="$(date +'%d.%m.%Y')" >> $1
printf "Build date:		%s\n" "$now" >> $1
echo "Author:			Mehmet Nuri Öztürk, www.mehmetnuriozturk.com.tr" >> $1
echo "Sources: 		http://github.com/MehmetNuri" >> $1
echo "" >> $1
echo "" >> $1
echo "" >> $1
echo "--------------------------------------------------------------------------------" >> $1
